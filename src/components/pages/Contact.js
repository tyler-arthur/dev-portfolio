      ...
      <div className="flex flex-col items-start justify-center w-2/3 mt-12 ml-56">
        ...
        <div className="w-2/3 self-center mt-24">
          ...
          >
            ...
            <textarea
              className="w-1/2 text-xl font-semibold rounded-lg text-justify text-center p-2 focus:outline-none focus:shadow-outline"
              name="name"
              type="text"
            ...
            <textarea
            className="w-1/2 text-lg rounded-lg text-justify text-center p-2 focus:outline-none focus:shadow-outline"
              name="message"
              type="text"
